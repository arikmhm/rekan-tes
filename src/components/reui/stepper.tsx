...
function StepperTrigger({
  ...
  // Dua blok di bawah membaca ref saat render. Berkas vendor: dibiarkan apa
  // adanya agar pembaruan komponen dari registry tidak bentrok dengan tambalan
  // lokal. Yang terpengaruh hanya navigasi panah antar-langkah.
  ...
  const defaultProps = {
    ...
    className: cn(
      "focus-visible:border-ring inline-flex cursor-pointer items-center outline-none focus-visible:z-10 disabled:pointer-events-none disabled:opacity-60",
